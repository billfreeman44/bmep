...
function bmep_blind_yexpect,maskname,filtername,slitname,ny,savepath,isstar=isstar
...
;  stop
  ...
  for i=0,n_elements(slitnames)-1 do begin
    ...
    pixscale=0.1799
    midpoint=ny/2
    yexpect=bmep_blind_yexpect(maskname,filtername,slitname,ny,savepath,isstar=isstar)
